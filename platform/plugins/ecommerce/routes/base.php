...
Route::group(['namespace' => 'Botble\Ecommerce\Http\Controllers', 'middleware' => ['web', 'core']], function () {
    Route::group(['prefix' => BaseHelper::getAdminPrefix() . '/ecommerce', 'middleware' => 'auth'], function () {
        ...
        Route::group(['prefix' => 'product-infos', 'as' => 'product-info.'], function () {
            Route::resource('', 'ProductInfoController')->parameters(['' => 'product-info']);
            Route::delete('items/destroy', [
                'as' => 'deletes',
                'uses' => 'ProductInfoController@deletes',
                'permission' => 'product-info.destroy',
            ]);
        });
