...
class RecetteTable extends TableAbstract
{
    protected $hasActions = true;

    protected $hasFilter = true;

    public function __construct(DataTables $table, UrlGenerator $urlGenerator, ProductInterface $recetteRepository)
    {
        parent::__construct($table, $urlGenerator);

        $this->repository = $recetteRepository;
    ...
    public function ajax(): JsonResponse
    {
        ...
        $data = $this->table
            ->eloquent($this->query())
            ->editColumn('name', function (Recette $item) {
            ...
            ->editColumn('continent', function (Recette $item) {
                return Html::link(route('products.edit', $item->id), BaseHelper::clean($item->continent));
            })
            ->editColumn('ingredient', function (Recette $item) {
                return Html::link(route('products.edit', $item->id), BaseHelper::clean($item->ingredient));
            })
            ->editColumn('repas', function (Recette $item) {
                return Html::link(route('products.edit', $item->id), BaseHelper::clean($item->repas));
            })
;
