...
use Botble\Ecommerce\Repositories\Caches\ProductInfoCacheDecorator;
...
use Botble\Ecommerce\Repositories\Eloquent\ProductInfoRepository;
...
class EcommerceServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(ProductInfoInterface::class, function () {
            return new ProductInfoCacheDecorator(
                new ProductInfoRepository(new ProductInfo())
            );
        });
    ...
    public function boot(): void
    {
        ...
        $this->app['events']->listen(RouteMatched::class, function () {
            dashboard_menu()
                ...
                ->registerItem([
                    'id' => 'cms-plugins-product-info',
                    'priority' => 9,
                    'parent_id' => 'cms-plugins-ecommerce',
                    'name' => "info",
                    'icon' => 'fas fa-tags',
                    'url' => route('product-info.index'),
                    'permissions' => ['product-info.index'],
                ])
                ->registerItem([
